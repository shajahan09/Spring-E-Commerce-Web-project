<%-- 
    Document   : menu
    Created on : 22-Oct-2019, 00:08:59
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <meta name="keywords" content="salling products" />
                                                ...
                                                <div class="mega-dropdown-menu">
                                                        <div class="w3ls_vegetables">
                                                                <ul class="dropdown-menu drp-mnu">
                                                                        <li><a href="/SpringWithHibernate/login">Login</a></li> 
                                                                        <li><a href="/SpringWithHibernate/signup">Sign Up</a></li>
                                                                </ul>
                                                        </div>                  
                                                </div>	
                                        </li>
        ...
        <!--<div class="logo_products">
                <div class="container">
                        <div class="w3ls_logo_products_left">
                                <h1><a href="#"><span>Bazar</span>DotCom</a></h1>
                        </div>
                        
                        <div class="w3ls_logo_products_left1">
                                <ul class="phone_email">
                                        <li><i class="fa fa-phone" aria-hidden="true"></i>(+880) 01856922061</li>
                                        <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="#">shajahan46083@gmail.com</a></li>
                                </ul>
                        </div>
                        <div class="clearfix"> </div>
                </div>
            ...
            <nav class="navbar nav_bottom">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav nav_1">
                        <li><a href="/SpringWithHibernate/products">Branded Foods</a></li>
                                ...
                                <figure>
                                    <div class="snipcart-item block" >
                                        <div class="snipcart-thumb">
                                            ...
                                            <h4>${columnProducts.price}<span>$10.00</span></h4>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details">
                                            <form action="addItem/${columnProducts.id}">
                                                <fieldset>
<!--                                                    <input type="hidden" name="cmd" value="_cart" />
                        ...
                        <div class="agile_top_brand_left_grid">
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block" >
                                        <div class="snipcart-thumb">
                                            <a href="single.html"><img title=" " alt=" " src="static/images/3.png" /></a>		
                        ...
                        <div class="agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="single.html"><img src="static/images/2.png" alt=" " class="img-responsive" /></a>
                        ...
                        <div class="agile_top_brand_left_grid">
                            ...
                            <div class="agile_top_brand_left_grid1">
                                <figure>
                                    <div class="snipcart-item block">
                                        <div class="snipcart-thumb">
                                            <a href="single.html"><img src="static/images/4.png" alt=" " class="img-responsive" /></a>
                                            <p>dogs food (4 Kg)</p>
            ...
            <div class="w3l_fresh_vegetables_grids">
                <div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_left">
                    <div class="w3l_fresh_vegetables_grid2">
                        <ul>
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="/SpringWithHibernate/productsPage">All Brands</a></li>
            ...
            <div class="footer">
                    <div class="container">
                            ...
                            <div class="wthree_footer_copy">
                                    <p>© All rights reserved | Design by <a href="#">parvez</a></p>
                            </div>
                    </div>
            </div>
     //footer 
