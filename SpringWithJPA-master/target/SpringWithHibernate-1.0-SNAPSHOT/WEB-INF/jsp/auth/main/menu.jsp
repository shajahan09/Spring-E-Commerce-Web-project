                                ...
                                <figure>
                                    <div class="snipcart-item block" >
                                        <div class="snipcart-thumb">
                                            <a href="#"><img title=" " alt=" " src="static/images/${columnProducts.img}" /></a>		
                                            <p align="center">${columnProducts.name}</p>
                                            <h4 align="center">${columnProducts.price} TK. <span>$530.00 TK.</span></h4>
                                        </div>
